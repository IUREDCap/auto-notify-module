...
class Help
{
    ...
    private static $help = [
        ...
        'query-builder' =>
            ...
            . "\n"
            . '<p>'
            . '<b>Conditions</b> Conditions have the following form:'
            . '<pre><i>variable</i> <i>operator</i> <i>value</i></pre>'
            . '</p>'
            . '<p>'
            . 'For condition values, note that:'
            . '<ul>'
            . '<li>Quotes will automatically be added for string values, so string values should be entered'
            . ' without quotes, unless the quotes are part of the actual value.</li>'
            . '<li>For date variables with age operators, the allowed values are an integer or negative'
            . ' integer followed by one of: years, months, weeks, days, hours, minutes, seconds. For example:'
            . ' "2 weeks". Age comparisons use SQL\'s TIMESTAMPDIFF function, which effectively truncates values'
            . ' based on the unit used. So, it would calculate a value of 1 year, for times that are 1 to 1.999... '
            . ' years from now. So a conditions of "> 1 year" would be equivalent to ">= 2 years".'
            . '<li>When using the "like" and "not like" operators, "%" can be used as a wildcard'
            ...
            . '<b>Buttons:</b>'
            . '<ul>'
            . '<li> <button><i class="fa fa-circle-plus" style="color: green;"></i></button>'
